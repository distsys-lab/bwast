...
class HashTreeTest {
    ...
    void getRequiredHashIds_4OutOf8_requiredRest4() {
        ...
        hashIds.flip(0, 4);
        byte[] tree = HashTree.generatePrunedTree(state, hashIds, 8);
    ...
    void addTree_twice8to4Tree_existsAllHashesWhen2TreeAdded() {
        ...
        hashIds1.set(2);
        hashIds1.set(3);
        byte[] tree1 = HashTree.generatePrunedTree(state, hashIds1, 8);
        ...
        hashIds2.set(6);
        hashIds2.set(7);
        byte[] tree2 = HashTree.generatePrunedTree(state, hashIds2, 8);
